...
import com.yb.retrofit.listener.UploadListener;
import com.yb.retrofit.utils.ProgressRequestBody;
import com.yb.retrofit.utils.ProgressResponseBody;
...
public final class HttpHelper {
    ...
    private HttpHelper() {
        //缓存路径
        mCacheFile = new File(YbHttp.getContext().getCacheDir().getAbsolutePath() + File.separator + "retrofit2_http_cache");
        //判断缓存路径是否存在
    ...
    public static okhttp3.Call upload(com.yb.retrofit.http.Request request, final UploadListener uploadListener) {
    ...
    private Interceptor createHttpInterceptor() {
        return new Interceptor() {
            ...
            public okhttp3.Response intercept(Chain chain) throws IOException {
                ...
                boolean isNetwork = isNetworkConnected(YbHttp.getContext());
